...
```{r 20a, echo=F}
ggplot(votes, aes(x=DemPctOfAbsenteeVotes, y=DemPctOfMachineVotes, shape=Disputed)) +
...
```{r 20b, echo=F}
ggplot(votes.out, aes(x=DemPctOfAbsenteeVotes, y=DemPctOfMachineVotes, shape=Disputed)) +
  geom_point(color='#2980B9', size = 4) +
...
```{r 20c, echo=F}
vote.lm <- lm(DemPctOfMachineVotes ~ DemPctOfAbsenteeVotes, data = votes)
